...
const INDUSTRIES = [
  { key: 'retail_general',         label: 'Retail & E-commerce' },
  { key: 'retail_grocery',         label: 'Grocery, Food Retail & Spaza' },
  { key: 'wholesale_distribution', label: 'Wholesale & Distribution' },
  { key: 'hospitality_restaurant', label: 'Restaurant, Cafe & Catering' },
  { key: 'hotel_accommodation',    label: 'Hotel, Guesthouse & Accommodation' },
  { key: 'manufacturing',          label: 'Manufacturing' },
  { key: 'construction',           label: 'Construction & Building' },
  { key: 'motor_trade',            label: 'Motor Trade & Automotive' },
  { key: 'logistics_trucking',     label: 'Transport & Logistics' },
  ...
  { key: 'personal_services',      label: 'Personal & Consumer Services' },
  ...
  { key: 'npo_social',             label: 'NPO & Social Enterprise' },
