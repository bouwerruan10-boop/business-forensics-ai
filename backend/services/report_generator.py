"""
Premium PDF Report Generator — Business Forensics AI
...
def _footer(canvas, doc):
    ...
    if page_num == 1:
        canvas.restoreState()
        return
    biz = doc.title or "Business Forensics AI"
...
def _cover_page_banker(story, report):
    ...
    story.append(Spacer(1, 0.15 * cm))
    story.append(Paragraph(
        "This credit assessment has been generated by Business Forensics AI for use by authorised "
...
def _cover_page_investor(story, report):
    ...
    story.append(Spacer(1, 0.15 * cm))
    story.append(Paragraph(
        "This investment analysis has been generated by Business Forensics AI. Valuations are "
...
def _closing_section(story, report):
    ...
    story.append(Spacer(1, 0.4 * cm))
    story.append(Paragraph(
        "This report has been prepared by Business Forensics AI and is intended solely for the "
