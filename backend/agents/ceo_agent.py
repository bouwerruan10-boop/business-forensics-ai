...
from agents.specialist_agents import ALL_AGENTS, SATaxAgent, SALegalAgent, TaxOptimizationAgent, TaxStructureRiskAgent
    ...
    def run_full_analysis(
        ...
        run_independent_agents(
            [
                ...
                (TaxStructureRiskAgent(), "GAAR & SARS Scrutiny",
                 "Flagging structures that can attract SARS/GAAR scrutiny (substance + documentation)..."),
...
"""
    ...
    def _generate_report(
        ...
        return {
            ...
            "tax_risk_flags": memory.tax_risk_flags,
